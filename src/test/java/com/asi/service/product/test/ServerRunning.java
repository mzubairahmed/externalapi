...
public class ServerRunning implements MethodRule {
	...
	public Statement apply(final Statement base, FrameworkMethod method, Object target) {
		...
		try {
			client.getForEntity(new UriTemplate(getUrl("productService")).toString(), String.class);
			online = true;
		...
		return new Statement() {
			...
			public void evaluate() throws Throwable {
				try {
					//postForStatus("productService/api/product/550023590", new LinkedMultiValueMap<String, String>());
					base.evaluate();
				} finally {
					//postForStatus("productService/api/product/550023590", new LinkedMultiValueMap<String, String>());
				}
