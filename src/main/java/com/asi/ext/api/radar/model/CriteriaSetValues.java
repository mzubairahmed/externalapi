...
public class CriteriaSetValues {
	...
	private String criteriaCode = "SHAP", valueTypeCode = "",
			criteriaValueDetail = "", isSubset = "",
			isSetValueMeasurement = "", criteriaSetId = "",
			baseLookupValue = "", productNumber = "";
	@JsonProperty("Value")
	private Object value = null;
	@JsonProperty("FormateValue")
