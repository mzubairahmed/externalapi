...
public class CriteriaInfo implements Serializable {
	 ...
	 */
	public void setDefaultPriceGridSubTypeCode(
			String defaultPriceGridSubTypeCode) {
	 ...
	 */
	public void setIsProductNumberAssignmentAllowed(
	...
	public int hashCode() {
		...
		result = prime
				* result
				+ ((criteriaTypeCode == null) ? 0 : criteriaTypeCode.hashCode());
		result = prime
				* result
				+ ((criteriaTypeDescription == null) ? 0
						: criteriaTypeDescription.hashCode());
		result = prime
				* result
				+ ((criteriaTypeDisplayName == null) ? 0
						: criteriaTypeDisplayName.hashCode());
		result = prime
				* result
				+ ((defaultPriceGridSubTypeCode == null) ? 0
						: defaultPriceGridSubTypeCode.hashCode());
		result = prime * result
		...
		result = prime
				* result
				+ ((isAllowBasePrice == null) ? 0 : isAllowBasePrice.hashCode());
		result = prime * result
				+ ((isAllowUpcharge == null) ? 0 : isAllowUpcharge.hashCode());
		result = prime * result + ((isFlag == null) ? 0 : isFlag.hashCode());
		result = prime
				* result
				+ ((isMediaAssignmentAllowed == null) ? 0
						: isMediaAssignmentAllowed.hashCode());
		result = prime
				* result
				+ ((isProductNumberAssignmentAllowed == null) ? 0
						: isProductNumberAssignmentAllowed.hashCode());
		return result;
	}
	...
	public boolean equals(Object obj) {
		...
		if (criteriaTypeCode == null) {
			if (other.criteriaTypeCode != null)
				return false;
		} else if (!criteriaTypeCode.equals(other.criteriaTypeCode))
			return false;
		if (criteriaTypeDescription == null) {
			if (other.criteriaTypeDescription != null)
				return false;
		} else if (!criteriaTypeDescription
				.equals(other.criteriaTypeDescription))
			return false;
		if (criteriaTypeDisplayName == null) {
			if (other.criteriaTypeDisplayName != null)
				return false;
		} else if (!criteriaTypeDisplayName
				.equals(other.criteriaTypeDisplayName))
			return false;
		if (defaultPriceGridSubTypeCode == null) {
			if (other.defaultPriceGridSubTypeCode != null)
				return false;
		} else if (!defaultPriceGridSubTypeCode
				.equals(other.defaultPriceGridSubTypeCode))
			return false;
		if (description == null) {
		...
		if (isAllowBasePrice == null) {
			if (other.isAllowBasePrice != null)
				return false;
		} else if (!isAllowBasePrice.equals(other.isAllowBasePrice))
			return false;
		if (isAllowUpcharge == null) {
			if (other.isAllowUpcharge != null)
				return false;
		} else if (!isAllowUpcharge.equals(other.isAllowUpcharge))
			return false;
		if (isFlag == null) {
			if (other.isFlag != null)
				return false;
		} else if (!isFlag.equals(other.isFlag))
			return false;
		if (isMediaAssignmentAllowed == null) {
			if (other.isMediaAssignmentAllowed != null)
				return false;
		} else if (!isMediaAssignmentAllowed
				.equals(other.isMediaAssignmentAllowed))
			return false;
		if (isProductNumberAssignmentAllowed == null) {
			if (other.isProductNumberAssignmentAllowed != null)
				return false;
		} else if (!isProductNumberAssignmentAllowed
				.equals(other.isProductNumberAssignmentAllowed))
			return false;
		return true;
	}
	...
	public String toString() {
		return "CriteriaInfo [code=" + code + ", description=" + description
				+ ", displayName=" + displayName + ", criteriaTypeCode="
				+ criteriaTypeCode + ", criteriaTypeDescription="
				+ criteriaTypeDescription + ", criteriaTypeDisplayName="
				+ criteriaTypeDisplayName + ", displaySequence="
				+ displaySequence + ", isAllowBasePrice=" + isAllowBasePrice
				+ ", isAllowUpcharge=" + isAllowUpcharge
				+ ", defaultPriceGridSubTypeCode="
				+ defaultPriceGridSubTypeCode + ", isFlag=" + isFlag
				+ ", isProductNumberAssignmentAllowed="
				+ isProductNumberAssignmentAllowed
				+ ", isMediaAssignmentAllowed=" + isMediaAssignmentAllowed
				+ "]";
	}
