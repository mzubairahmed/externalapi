...
public class ProductCriteriaSets implements Serializable {
	...
	public ProductCriteriaSets(String criteriaSetId, String productId,
			String companyId, String configId, String parentCriteriaSetId,
			String description, String criteriaCode, String isBase,
			String isRequiredForOrder, String isMultipleChoiceAllowed,
			String isTemplate, String orderDetail, String criteriaDetail,
			String isDefaultConfiguration, String displayProductNumber,
			String displayOptionName, String isBrokenOutOn,
	...
	private String criteriaSetId = "", productId = "", companyId = "",
			configId = "", parentCriteriaSetId = "0", description = "",
			criteriaCode = "SHAP", isBase = "false",
			isRequiredForOrder = "false";
	@JsonProperty("IsMultipleChoiceAllowed")
	private String isMultipleChoiceAllowed = "false", isTemplate = "false",
			orderDetail = "", criteriaDetail = "",
			isDefaultConfiguration = "true";
	@JsonProperty("DisplayProductNumber")
	private String displayProductNumber = "", displayOptionName = "",
			isBrokenOutOn = "false";
