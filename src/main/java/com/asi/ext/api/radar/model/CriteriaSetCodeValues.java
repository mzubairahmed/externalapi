...
public class CriteriaSetCodeValues {
	 ...
	 */
	public CriteriaSetCodeValues(String id, String criteriaSetValueId,
			String setCodeValueId, String codeValue, String codeValueDetail,
	...
	public String toString() {
		return "CriteriaSetCodeValues [id=" + id + ", criteriaSetValueId="
				+ criteriaSetValueId + ", setCodeValueId=" + setCodeValueId
				+ ", codeValue=" + codeValue + ", codeValueDetail="
				+ codeValueDetail + ", childCriteriaSetCodeValues="
				+ Arrays.toString(childCriteriaSetCodeValues) + "]";
	}
