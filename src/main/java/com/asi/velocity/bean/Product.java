...
public class Product {
    ...
    /**
     * @param proofProdGroupId the proofProdGroupId to set
     */
    ...
    /**
     * @param proofPageNo the proofPageNo to set
     */
    ...
    /**
     * @param proofSubIssueId the proofSubIssueId to set
     */
    ...
    /**
     * @param show1ProdNo the show1ProdNo to set
     */
    ...
    /**
     * @param show1PriceGridId the show1PriceGridId to set
     */
    ...
    /**
     * @param includeAppOfferList the includeAppOfferList to set
     */
